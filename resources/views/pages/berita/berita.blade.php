...
<section class="py-24 bg-white relative overflow-hidden">
    ...
    {{-- Aksen Latar Ringan (biru) --}}
    <div class="absolute top-10 right-10 w-72 h-72 bg-blue-50 rounded-full blur-3xl pointer-events-none"></div>

    <div class="max-w-7xl mx-auto px-6 relative z-10">
        
        {{-- HEADER SECTION dengan gradasi --}}
        <div class="text-center max-w-2xl mx-auto mb-12">
            <span class="text-blue-600 font-bold tracking-widest uppercase text-xs mb-3 block">Informasi & Kegiatan Sekolah</span>
            <h2 class="text-4xl md:text-5xl font-black text-gray-800 font-['Poppins']">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">
                    Berita Terbaru
                </span>
            </h2>
            <div class="w-20 h-1.5 bg-gradient-to-r from-blue-600 to-blue-400 mx-auto mt-6 rounded-full"></div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {{-- Item Berita Utama 1 --}}
            <article class="bg-blue-50 rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group flex flex-col">
                <div class="relative overflow-hidden aspect-[16/10]">
                    ...
                    {{-- Badge kategori dengan gradasi biru --}}
                    <div class="absolute top-4 left-4 bg-gradient-to-r from-blue-500 to-blue-400 text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-md">
                        Prestasi
                    </div>
                </div>
                <div class="p-6 md:p-8 flex flex-col flex-grow">
                    <div class="flex items-center gap-4 text-xs text-gray-500 mb-3">
                        <span><i class="fa-regular fa-calendar-days text-blue-500 mr-1.5"></i> 25 Juni 2026</span>
                    </div>
                    <h3 class="font-bold text-gray-800 text-xl font-['Poppins'] mb-3 group-hover:text-blue-600 transition-colors line-clamp-2">
                    ...
                    <div class="mt-auto pt-4 border-t border-gray-200/60">
                        <a href="#" class="inline-flex items-center gap-2 text-sm font-semibold text-blue-600 group-hover:underline">
            ...
            <article class="bg-blue-50 rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group flex flex-col">
                ...
                <div class="p-6 md:p-8 flex flex-col flex-grow">
                    <div class="flex items-center gap-4 text-xs text-gray-500 mb-3">
                        <span><i class="fa-regular fa-calendar-days text-blue-500 mr-1.5"></i> 18 Juni 2026</span>
                    </div>
                    <h3 class="font-bold text-gray-800 text-xl font-['Poppins'] mb-3 group-hover:text-blue-600 transition-colors line-clamp-2">
            ...
            <article class="bg-blue-50 rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group flex flex-col">
                ...
                <div class="p-6 md:p-8 flex flex-col flex-grow">
                    <div class="flex items-center gap-4 text-xs text-gray-500 mb-3">
                        <span><i class="fa-regular fa-calendar-days text-blue-500 mr-1.5"></i> 10 Juni 2026</span>
                    </div>
                    <h3 class="font-bold text-gray-800 text-xl font-['Poppins'] mb-3 group-hover:text-blue-600 transition-colors line-clamp-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mt-10">
            ...
            {{-- List Kiri 1 --}}
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-blue-50/50 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    <h4 class="text-base md:text-lg font-bold text-gray-800 font-['Poppins'] leading-snug group-hover:text-blue-600 transition-colors line-clamp-2">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-blue-500"></i> 55 menit yang lalu
                    </p>
                </div>
            </a>
            ...
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-blue-50/50 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-blue-500"></i> 1 jam yang lalu
                    </p>
                </div>
            </a>
            ...
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-blue-50/50 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-blue-500"></i> 3 jam yang lalu
                    </p>
                </div>
            </a>
            ...
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-blue-50/50 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-blue-500"></i> 5 jam yang lalu
                    </p>
                </div>
            </a>
        ...
        {{-- Button Lihat Semua Berita dengan gradasi border & hover --}}
        <div class="mt-16 text-center">
            <a href="#" class="inline-flex items-center gap-2 px-8 py-4 bg-white border-2 border-blue-600 text-blue-600 rounded-xl font-semibold hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-400 hover:text-white transition-all shadow-sm hover:shadow-lg transform hover:-translate-y-1">
