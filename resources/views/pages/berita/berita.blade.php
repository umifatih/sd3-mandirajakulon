...
<section class="py-24 bg-white relative overflow-hidden">
    ...
    <div class="absolute top-10 right-10 w-72 h-72 bg-[#EBF5FA] rounded-full blur-3xl pointer-events-none"></div>

    <div class="max-w-7xl mx-auto px-6 relative z-10">
        
        {{-- HEADER SECTION dengan gradasi --}}
        <div class="text-center max-w-2xl mx-auto mb-12">
            <span class="text-[#18587A] font-bold tracking-widest uppercase text-xs mb-3 block">Informasi & Kegiatan Sekolah</span>
            <h2 class="text-4xl md:text-5xl font-black text-gray-800 font-['Poppins']">
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#18587A] to-[#85C2DB]">
                    Berita Terbaru
                </span>
            </h2>
            <div class="w-20 h-1.5 bg-gradient-to-r from-[#18587A] to-[#85C2DB] mx-auto mt-6 rounded-full"></div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {{-- Item Berita Utama 1 --}}
            <article class="bg-[#EBF5FA] rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group flex flex-col">
                <div class="relative overflow-hidden aspect-[16/10]">
                    ...
                    <div class="absolute top-4 left-4 bg-gradient-to-r from-[#18587A] to-[#85C2DB] text-white text-xs font-semibold px-3 py-1.5 rounded-full shadow-md">
                        Prestasi
                    </div>
                </div>
                <div class="p-6 md:p-8 flex flex-col flex-grow">
                    <div class="flex items-center gap-4 text-xs text-gray-500 mb-3">
                        <span><i class="fa-regular fa-calendar-days text-[#18587A] mr-1.5"></i> 25 Juni 2026</span>
                    </div>
                    <h3 class="font-bold text-gray-800 text-xl font-['Poppins'] mb-3 group-hover:text-[#18587A] transition-colors line-clamp-2">
                    ...
                    <div class="mt-auto pt-4 border-t border-gray-200/60">
                        <a href="#" class="inline-flex items-center gap-2 text-sm font-semibold text-[#18587A] group-hover:underline">
            ...
            <article class="bg-[#EBF5FA] rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group flex flex-col">
                ...
                <div class="p-6 md:p-8 flex flex-col flex-grow">
                    <div class="flex items-center gap-4 text-xs text-gray-500 mb-3">
                        <span><i class="fa-regular fa-calendar-days text-[#18587A] mr-1.5"></i> 18 Juni 2026</span>
                    </div>
                    <h3 class="font-bold text-gray-800 text-xl font-['Poppins'] mb-3 group-hover:text-[#18587A] transition-colors line-clamp-2">
            ...
            <article class="bg-[#EBF5FA] rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group flex flex-col">
                ...
                <div class="p-6 md:p-8 flex flex-col flex-grow">
                    <div class="flex items-center gap-4 text-xs text-gray-500 mb-3">
                        <span><i class="fa-regular fa-calendar-days text-[#18587A] mr-1.5"></i> 10 Juni 2026</span>
                    </div>
                    <h3 class="font-bold text-gray-800 text-xl font-['Poppins'] mb-3 group-hover:text-[#18587A] transition-colors line-clamp-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 mt-10">
            ...
            {{-- List Kiri 1 --}}
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-[#EBF5FA]/80 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    <h4 class="text-base md:text-lg font-bold text-gray-800 font-['Poppins'] leading-snug group-hover:text-[#18587A] transition-colors line-clamp-2">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-[#85C2DB]"></i> 55 menit yang lalu
                    </p>
                </div>
            </a>
            ...
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-[#EBF5FA]/80 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-[#85C2DB]"></i> 1 jam yang lalu
                    </p>
                </div>
            </a>
            ...
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-[#EBF5FA]/80 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-[#85C2DB]"></i> 3 jam yang lalu
                    </p>
                </div>
            </a>
            ...
            <a href="#" class="group flex flex-row gap-4 md:gap-6 items-center hover:bg-[#EBF5FA]/80 p-3 -ml-3 md:p-4 md:-ml-4 rounded-2xl transition-all duration-300">
                ...
                <div class="flex-col flex">
                    ...
                    <p class="text-xs text-gray-500 font-medium mt-2 flex items-center gap-2">
                        <i class="fa-regular fa-clock text-[#85C2DB]"></i> 5 jam yang lalu
                    </p>
                </div>
            </a>
        ...
        {{-- Button Lihat Semua Berita dengan hover solid color --}}
